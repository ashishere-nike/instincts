...
import com.borntowindevelopers.instincts.ui.AnimatorListener;
import com.borntowindevelopers.instincts.ui.SpotlightView;
...
public class EDetailActivity extends AbstractDetailActivity {
    ...
    private Bitmap setupPhoto(int resource) {
        Bitmap bitmap = EventActivity.sPhotoCache1.get(resource);
